 ...
 *       tags: [Masking]
 *       description: |
 *         주민등록증의 이미지를 파일 형식 또는 Base64로 인코딩된 데이터로 받아, 마스킹 처리된 이미지를 Base64 인코딩 값으로 반환합니다.
 *
 ...
 *                 image_base64:
 *                   type: string
 *                   description: 주민등록증 이미지 (base64 인코딩) `optional`
 *                   example: ""
 *                 image:
 *                   type: string
 *                   format: binary
 *                   description: 주민등록증 이미지 (jpg, png, pdf 형식) `optional`
 *                 secret_mode:
 *                   type: boolean
 ...
 *                       image_base64_mask:
 *                         type: string
 *                         description: 마스킹 처리 된 주민등록증 이미지 (`iVBORw0KGgoAAAA...........OAGVKw4bAAAAB3RJTUU`)
 *                   transaction_id:
 *                     type: string
