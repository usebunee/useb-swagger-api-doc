...
const firmCustomRealnameRouter = express.Router();

//! 펌뱅킹-프리미엄 계좌실명조회
/**
 * @swagger
 * paths:
 *   /firmbank-custom/realname:
 *     post:
 *       summary: 계좌실명조회 [펌뱅킹-프리미엄]
 ...
 *                          | RN003 | 생년월일 또는 사업자등록번호 정보가 잘못된 경우 |
 ...
 *                   summary: RN003 | 생년월일 또는 사업자등록번호 정보가 잘못된 경우
 *                   value:
 *                     success: false
...
module.exports = firmCustomRealnameRouter;
